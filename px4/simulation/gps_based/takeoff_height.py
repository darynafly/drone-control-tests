...
class OffboardNode(Node):
    def __init__(self):
        ...
        self.pose.pose.position.z = self.height  # Desired altitude for takeoff
    ...
    def takeoff_alt(self):
        # Maintain target altitude during takeoff
        self.pose.pose.position.z = self.height  # Keep the altitude target
        self.local_pos_pub.publish(self.pose)  # Publish position setpoint
