...
class OdomRepub(Node):
    ...
    def __init__(self, yaw_shift):
        ...
        self.odom_publisher = self.create_publisher(Odometry, '/gps_shifted_odometry', 10)
...
def main(args=None):
    ...
    #yaw_shift = np.radians(-50)  # squares_unticlockwise
    #yaw_shift = np.radians(27)  # squares_clockwise
    #yaw_shift = np.radians(5)  # squares_clockwise_2
    #yaw_shift = np.radians(30)  # squares_unticlockwise_2/
    #yaw_shift = np.radians(0)  # lines/
    yaw_shift = np.radians(30)  # lines_4/
